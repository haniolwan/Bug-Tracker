                        ...
                        <div class="card-body" style="height:500px ">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm"><span class="dot"></span>
                                    Graph Api <span class="text-secondary text-sm">in NothingWorks</span></span>
                                </div>
                                <div class="col-sm">
                                    <div class="avatars">
                                ...
                                <div class="col-sm-3 text-secondary">March 30 ,2020</div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3 text-secondary">January 28 ,2020</div>
                                <div class="col-sm-.05 text-secondary"><a class="text-secondary" href=""><i class="fas fa-ellipsis-v"></a></i></div>
                            </div>
                            <!-- Third item -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3 text-secondary">February 14 ,2020</div>
                                <div class="col-sm-.05 text-secondary"><a class="text-secondary" href=""><i class="fas fa-ellipsis-v"></a></i></div>
                            </div>
